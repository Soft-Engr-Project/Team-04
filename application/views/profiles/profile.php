    <div class="cover">
        <?php if(!empty($user["user_cover_photo"])){?>
            <img src="<?php echo base_url();?>assets/images/posts/<?php echo $user["user_cover_photo"];?>" id="coverphoto">
                ...
                <div class="profile">
                    <div class="profileimage">
                        <?php if(!empty($user["user_profile_photo"])){?>
                            <img src="<?php echo base_url();?>assets/images/posts/<?php echo $user["user_profile_photo"];?>" id="coverphoto">
                        <!-- <input type="file" id="filecover"> -->
                        <?php }else{?>
